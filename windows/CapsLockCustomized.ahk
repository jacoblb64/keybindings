...
;-----------------------------------o---------------------------------o
;                   CapsLock + i    |  Mouse Up                      ;|
;                   CapsLock + k    |  Mouse Down                    ;|
;                   CapsLock + j    |  Mouse Left                    ;|
;                   CapsLock + l    |  Mouse Right                   ;|
;                   CapsLock + u    |  Mouse Left Push(Release)      ;|
;-----------------------------------o---------------------------------o
CapsLock & i::    MouseMove, 0, -10, 0, R                           ;|
CapsLock & k::  MouseMove, 0, 10, 0, R                            ;|
CapsLock & j::  MouseMove, -10, 0, 0, R                           ;|
